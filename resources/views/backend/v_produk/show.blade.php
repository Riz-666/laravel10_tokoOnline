                                ...
                                <div id="foto-container">
                                    <div class="row">
                                        @foreach ($show->fotoProduk as $gambar)
                                            ...
                                            <div class="col-md-4">
                                                <form action="{{ route('backend.destroy_foto_produk.destroy', $gambar->id) }}" method="post">
                                                    @csrf
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        addFotoButton.addEventListener('click', function() {
            ...
            fotoRow.innerHTML = `
<form action="{{ route('backend.produk.storeFoto') }}" method="post" enctype="multipart/form-data">
@csrf
<div class="col-md-12">
