                        ...
                        <div class="row p-b-30">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg" name="email" id="" value="{{ old('email') }}" class="@error('email') is-invalid @enderror" placeholder="masukan email">
                                    @error('email')
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="password" class="form-control form-control-lg" name="password" id="" value="{{ old('password') }}" class="@error('password') is-invalid @enderror" placeholder="masukan password">
                                    @error('password')
                                    <span class="invalid-feedback alert-danger">{{ $message }}</span>
                                    @enderror
                                </div>
